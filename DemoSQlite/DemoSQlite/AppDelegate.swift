...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /* Add the libsqlite3.dylib by clicking Add Other in Linked Binary Framework. Then give command + Shift + G, which opens a dialog, enter /usr/lib. Select the framework. */
    func dbCreation() {
        print("db")
